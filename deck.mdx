...
- [Développeur PHP Expert](https://www.welcometothejungle.co/fr/companies/jolicode/jobs/developpeur-php-expert_lausanne)
...
<Notes>
  J’ai fait mes armes à JoliCode, une société de conseils basé sur paris et
  Lausanne, qui propose un niveau d’expertise très élevé sur les frameworks PHP
...
<Notes>
  Aujourd’hui, je pilote désormais l’activité d’expertise React sous la bannière
  de Premier Octet, qui est une filiale de JoliCode spécialisée dans les technos
...
## What I find hard on mobile
  ...
  <ul>
    ...
    <Appear>
      <li>
        <strong>Navigation (which is using all of the above 😅)</strong>
      </li>
    </Appear>
  </ul>
</Invert>
...
- 🤖 [Android](https://material.io/design/navigation/understanding-navigation.html)
...
- Login/Register : multiple navigators and reset stack
- Deep link : access any screen from anywhere
- App link : open an other app and come back
...
🤔 IMHO React Navigation is the best option

☝️ Go with RNN if you want to stay as close as possible with the OS implementation
...
☝️ Display a native splash screen
...
🙌 : [Harris Freddy](http://react-navigation-keynote.surge.sh) and [Brent Vatnes](https://www.youtube.com/watch?v=GBhdooVxX6Q) for their presentations
